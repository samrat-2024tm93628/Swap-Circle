...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Account created! You got 5 starter credits.');
      navigate('/dashboard');
    } catch (err) {
    ...
    <div className="min-h-[calc(100vh-65px)] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 font-bold text-2xl text-dark mb-2">
            <ArrowLeftRight className="text-primary-500" size={24} />
            SwapCircle
          </div>
          <p className="text-gray-500">Create your account — it's free</p>
        </div>
